...
**为何：** 落实 ADR 0021（策略在上）；App 收纳 Subscriptions 深链/About（无 Appearance，见 0028）；根页不为抽象审计项占位。

**后果：** 术语见 CONTEXT **Settings Surface**；hi-fi 与 `00-ia` 以本 ADR + 0021 / 0025 / **0051** 为准。
